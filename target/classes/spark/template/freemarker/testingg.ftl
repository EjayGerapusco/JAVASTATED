...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card-2">
    ...
    <a href="#band" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Add</a>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="mySlides w3-display-container w3-center">
    <img src="https://appdevelopermagazine.com/images/news_images/Making-Application-Testing-a-First-Class-Citizen-App-Developer-Magazine_gd5jd6gn.jpg" style="width:100%">
  ...
  <div id="ticketModal" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-8">
      ...
      <div class="w3-container">
        ...
        <button class="w3-button w3-block w3-teal w3-padding-12 w3-section w3-right">PAY <i class="fa fa-check"></i></button>
